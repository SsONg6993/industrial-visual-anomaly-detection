...
OUTPUT_CSV = (
    REPORT_DIR
    / "v2b_highres32_image_scores.csv"
)
...
# ============================================================
# 6. High-resolution feature fusion
# ============================================================
...
def infer_image_score(
    ...
    with torch.no_grad():
        ...
        # IMPORTANT:
        #
        # Test-time uses ALL 32x32 patches.
        #
        # No stride=2 here.
        # ---------------------------------------------
...
# ============================================================
# 14. Find exploratory best-F1 threshold
# ============================================================
...
print(
    "V2B HIGH-RES32 IMAGE-LEVEL EVALUATION"
)
